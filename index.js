...
var gltfPath='./models/gltf/dinci.gltf';
...
var loadedFn=function(gltf){
  ...
  light.position.set( -500, 5000, 1000 );
  scene.add( light );

  //3-camera
  var camera=new THREE.PerspectiveCamera(75,size[0]/size[1],100,1e6);
  camera.position.set(-10,100,4300);
